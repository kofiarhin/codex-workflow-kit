...
| File Path | Lock Owner | Worker ID | Task ID | Run ID | Reason | Lock Status | Acquired At | Released At |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `<path>` | `<agent/orchestrator>` | `<worker-id>` | `<TASK-000>` | `<run-id>` | `<why this file is needed>` | `<active / released / blocked / needs-review>` | `<YYYY-MM-DD HH:MM>` | `<YYYY-MM-DD HH:MM or pending>` |
