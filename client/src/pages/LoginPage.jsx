  ...
  return (
    <section className="mx-auto grid max-w-7xl gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:py-16">
      <div className="animate-rise-in order-2 lg:order-1">
        <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-soft sm:p-7 dark:border-zinc-800 dark:bg-zinc-900">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-zinc-500 dark:text-zinc-500">
            Session
          </p>
          <h1 className="mt-4 text-3xl font-semibold tracking-tighter text-zinc-950 md:text-5xl dark:text-white">
      ...
      <div className="animate-rise-in order-1 grid content-between rounded-lg bg-zinc-950 p-6 text-white shadow-soft lg:order-2 lg:min-h-[520px] dark:border dark:border-zinc-800">
        <div>
